 ...
 return (
  ...
  >
   ...
   {onUndo && (
    <button
     onClick={onUndo}
     className="ml-2 text-xs font-semibold text-rose-400 hover:text-rose-300 underline underline-offset-2 transition-colors rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500"
    >
     Undo
    </button>
   )}
