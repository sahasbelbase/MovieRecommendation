  ...
  >
   ...
   {onUndo && (
    <button
     type="button"
     onClick={onUndo}
     className="ml-2 text-xs font-semibold text-rose-400 hover:text-rose-300 underline underline-offset-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded px-1"
    >
     Undo
    </button>
   )}
   <button
    ...
    className="text-zinc-500 hover:text-zinc-300 transition-colors p-1 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-500"
   >
