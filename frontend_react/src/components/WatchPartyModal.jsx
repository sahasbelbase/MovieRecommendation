              ...
              <div className="relative w-full h-full flex flex-col justify-center items-center p-0 sm:p-3">
                {isScreenSharing ? (
                  ...
                  <div className="flex flex-col items-center justify-center p-6 text-center space-y-4 max-w-md">
                    <div className="w-14 h-14 rounded-2xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center text-purple-400 shadow-xl shadow-purple-950/40">
                      <Monitor className="w-7 h-7 animate-pulse" />
                    </div>
                    <div>
                      <h3 className="text-base sm:text-lg font-bold text-white">
                        {isHost ? 'SharePlay Screen Sharing' : 'Live Screen Stream'}
                      </h3>
                      <p className="text-xs text-zinc-400 mt-1 max-w-sm leading-relaxed">
                        {isHost
                          ...
                          : `Waiting for host (${hostName || 'Host'}) to start sharing screen...`}
                      </p>
                    </div>
